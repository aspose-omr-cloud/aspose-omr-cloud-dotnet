...
namespace Aspose.Omr.Cloud.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OMRRecognitionResponse :  IEquatable<OMRRecognitionResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OMRRecognitionResponse" /> class.
        /// </summary>
        /// <param name="results">results.</param>
        /// <param name="id">id.</param>
        /// <param name="responseStatusCode">responseStatusCode.</param>
        /// <param name="error">error.</param>
        public OMRRecognitionResponse(List<OMRResult> results = default(List<OMRResult>), string id = default(string), ResponseStatusCode responseStatusCode = default(ResponseStatusCode), OMRError error = default(OMRError))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OMRRecognitionResponse {\n");
        ...
        {
            return this.Equals(input as OMRRecognitionResponse);
        }

        /// <summary>
        /// Returns true if OMRRecognitionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OMRRecognitionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OMRRecognitionResponse input)
        {
            if (input == null)
                return false;
