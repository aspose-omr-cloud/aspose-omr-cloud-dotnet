...
namespace Aspose.Omr.Cloud.Sdk.Client
{
        ...
        public class Configuration : IReadableConfiguration
    {
        ...
        /// <summary>
        /// Gets or sets the Client ID key.
        /// </summary>
        ...
        {
            String report = "C# SDK (Aspose.Omr.Cloud.Sdk) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: v5\n";
        ...
        private string GetToken()
        {
            ...
            TokenResponse deserialized = JsonConvert.DeserializeObject<TokenResponse>(response.Content);
            _accessToken = $"{deserialized.TokenType} {deserialized.AccessToken}";
            return _accessToken;
        }
        #endregion Methods
    }
