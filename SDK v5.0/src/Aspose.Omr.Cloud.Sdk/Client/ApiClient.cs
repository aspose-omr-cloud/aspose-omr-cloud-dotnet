...
using RestSharp;
using Aspose.Omr.Cloud.Sdk.Client.Auth;
...
namespace Aspose.Omr.Cloud.Sdk.Client
{
        ...
        public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = Aspose.Omr.Cloud.Sdk.Client.Configuration.Default;
        ...
        {
            Configuration = config ?? Aspose.Omr.Cloud.Sdk.Client.Configuration.Default;
        ...
        private RestRequest PrepareRequest(
            ...
            String contentType)
        {
            var aPath = GetAdjustedPath(path);
            var request = new RestRequest(GetAdjustedPath(path), method);
            ...
            request.AddHeader("Authorization", Configuration.AccessToken);
            return request;
        }
